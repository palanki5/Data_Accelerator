...
from ingestion_fw.utils.utils import insert_record_batch_seq_detail, get_batch_seq_id_for_this_run
...
def main():
    ...
    logger.info("RDBMS Tables:Sequence ID Value For This Execution Run..... {0}".format(next_seq_id_str))
