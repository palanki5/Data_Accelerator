...
from utils.utils import insert_record_batch_seq_detail, get_batch_seq_id_for_this_run
...
def parse_cmd_args():
    ...
    """
    cmd_parser = argparse.ArgumentParser(description="Ingestion Framework Streaming module")
...
def main():
    ...
    logger.info("Sreaming Data:Sequence ID Value For This Execution Run..... {0}".format(next_seq_id_str))
    ...
    # This value can be used at later stage in update and insert query
